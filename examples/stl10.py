...
def train():
    ...
    train_dataset = STL10(root='./data', split='train', transform=transforms.ToTensor(), download=True)
    val_dataset = STL10(root='./data', split='test', transform=transforms.ToTensor(), download=True)
